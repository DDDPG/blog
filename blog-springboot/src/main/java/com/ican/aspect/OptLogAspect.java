...
public class OptLogAspect {
     ...
     */
    @Pointcut("@annotation(com.ican.annotation.OptLog)")
    ...
    public void doAfterReturning(JoinPoint joinPoint, Object result) {
        ...
        // 操作类型
        operationLog.setType(optLog.optType());
        // 请求URI
        ...
        // 请求用户昵称
        operationLog.setNickname(SecurityUtils.getNickName());
        // 操作ip和操作地址
        String ip = IpUtils.getIpAddress(request);
        operationLog.setIpAddress(ip);
        operationLog.setIpSource(IpUtils.getCityInfo(ip));
        // 执行耗时
