...
public class ExceptionLogServiceImpl extends ServiceImpl<ExceptionLogMapper, ExceptionLog> implements ExceptionLogService {
    ...
    @Override
    public PageResult<ExceptionLogVO> listExceptionLogVO(ConditionDTO condition) {
        // 查询异常日志数量
        ...
        // 查询异常日志列表
        List<ExceptionLogVO> exceptionLogVOList = exceptionLogMapper.selectExceptionLogVOList(PageUtils.getLimit(), PageUtils.getSize(), condition);
        return new PageResult<>(exceptionLogVOList, count);
    }
